...
let createPlayer = () => {
    ...
    for (let i = 0; i < 4; i++) {
        if (gameBoardModule.playerArray.length >= 6) {
            ...
            let playerNumber = 1;
            let assignedXO = "X";
            alert("You are the player 1, and your assigned letter is X!");
            ...
            let playerNumber = 2;
            let assignedXO = "O";
            alert("You are the player 2, and your assigned letter is O!");
            gameBoardModule.playerArray.push(playerName, playerNumber, assignedXO);
            console.log("Show me the contents of the playerArray....", gameBoardModule.playerArray);
        }
...
let gameBoardModule = (function () {
    ...
    // Public exposed function to envoke next player move
    let makePlayerMove = () => {

        // Check for two player submission and gameBoard array doesn's spill over gridboxes
